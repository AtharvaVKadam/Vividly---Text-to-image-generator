...
const Header = () => {
  return (
    <div className="flex flex-col justify-center items-center text-center my-20">
      ...
      <h1 className="text-4xl sm:text-7xl font-semibold leading-[1.05] max-w-162.5 mx-auto mt-10 text-center">
        Turn text to
      ...
      <p className="mt-2 text-neutral-600">Generated images from Vividly</p>
    </div>
  );
};
